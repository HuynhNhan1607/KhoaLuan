...
#define SDA_PIN 8 // đổi tùy ý
#define SCL_PIN 9 // đổi tùy ý
...
#define BNO_ERR_NOT_CONFIGMODE (0xB05505)
...
typedef struct
{
    double heading; // góc yaw (quay quanh trục Z)
    double roll;    // góc roll (quay quanh trục X)
    double pitch;   // góc pitch (quay quanh trục Y)
} bno055_euler_t;
