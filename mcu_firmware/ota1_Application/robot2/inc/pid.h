...
#define PID_AUTOTUNE_TARGET_RPM 70.0f // Fixed autotune target (70 RPM)
#define PID_AUTOTUNE_HYSTERESIS 2.0f  // RPM hysteresis for relay
...
typedef struct
{
    ...
    float rpm_peak_max;                                     // Maximum RPM during autotune
    float rpm_peak_min;                                     // Minimum RPM during autotune
